...
SOLVED_STEP1_CUBIE_BW = [0 for i in range(20)]
...
class Cube():
    ...
    def bw_cube(self):
        self.get_cube_state()
        bw_cube = self.cube_cubies[1::2]
        bw_cube[self.cube_cubies[16::2].index(8)+8] += 2
        bw_cube[self.cube_cubies[16::2].index(9)+8] += 2
        bw_cube[self.cube_cubies[16::2].index(10)+8] += 2
        bw_cube[self.cube_cubies[16::2].index(11)+8] += 2
        return bw_cube


class Cube_BW():
    """A cube that can be visualised, permutated and solved. Differs from Cube() in that only orientation of the cubies is recorded (for step 1 of the solving process)
    ...
    def __init__(self, solved=True, scramble=None, size=3, colors=[COLORS_LIST[0],COLORS_LIST[2]]):
        """Inits Cube.
        ...
        if solved: # generates a solved cube
            self.stickers_used = True
            self.cube_cubies = None
            self.cube_stickers = [[[0 for i in range(self.size)] for j in range(self.size)] for k in range(6)]
            for i in range(3):
                self.cube_stickers[0][0][i] = 1
                self.cube_stickers[0][2][i] = 1

                self.cube_stickers[1][0][i] = 1
                self.cube_stickers[1][2][i] = 1

            self.cube_stickers[0][1][0] = 1
            self.cube_stickers[0][1][2] = 1

            self.cube_stickers[1][1][0] = 1
            self.cube_stickers[1][1][2] = 1

            self.cube_stickers[2][1][0] = 2
            self.cube_stickers[2][1][2] = 2

            self.cube_stickers[3][1][0] = 2
            self.cube_stickers[3][1][2] = 2
    ...
    def get_cube_state(self, sticker_notation=False, cubie_list=CUBIE_LIST):
        ...
        if sticker_notation:
            if not self.stickers_used:
                ...
                # corners
                # 00
                if self.cube_cubies[0] == 0: self.cube_stickers[0][0][0] = 1
                elif self.cube_cubies[0] == 1: self.cube_stickers[5][0][2] = 1
                elif self.cube_cubies[0] == 2: self.cube_stickers[3][0][2] = 1
                # 01
                if self.cube_cubies[1] == 0: self.cube_stickers[0][0][2] = 1
                elif self.cube_cubies[1] == 1: self.cube_stickers[3][0][0] = 1
                elif self.cube_cubies[1] == 2: self.cube_stickers[4][0][0] = 1
                # 02
                if self.cube_cubies[2] == 0: self.cube_stickers[0][2][2] = 1
                elif self.cube_cubies[2] == 1: self.cube_stickers[4][2][0] = 1
                elif self.cube_cubies[2] == 2: self.cube_stickers[2][0][2] = 1
                # 03
                if self.cube_cubies[3] == 0: self.cube_stickers[0][2][0] = 1
                elif self.cube_cubies[3] == 1: self.cube_stickers[2][0][0] = 1
                elif self.cube_cubies[3] == 2: self.cube_stickers[5][2][2] = 1
                # 04
                if self.cube_cubies[4] == 0: self.cube_stickers[1][0][2] = 1
                elif self.cube_cubies[4] == 1: self.cube_stickers[3][2][2] = 1
                elif self.cube_cubies[4] == 2: self.cube_stickers[5][0][0] = 1
                # 05
                if self.cube_cubies[5] == 0: self.cube_stickers[1][0][0] = 1
                elif self.cube_cubies[5] == 1: self.cube_stickers[4][0][2] = 1
                elif self.cube_cubies[5] == 2: self.cube_stickers[3][2][0] = 1
                # 06
                if self.cube_cubies[6] == 0: self.cube_stickers[1][2][0] = 1
                elif self.cube_cubies[6] == 1: self.cube_stickers[2][2][2] = 1
                elif self.cube_cubies[6] == 2: self.cube_stickers[4][2][2] = 1
                # 07
                if self.cube_cubies[7] == 0: self.cube_stickers[1][2][2] = 1
                elif self.cube_cubies[7] == 1: self.cube_stickers[5][2][0] = 1
                elif self.cube_cubies[7] == 2: self.cube_stickers[2][2][0] = 1

                # edges
                # 10
                if self.cube_cubies[8] == 0: self.cube_stickers[0][0][1] = 1
                elif self.cube_cubies[8] == 1: self.cube_stickers[3][0][1] = 1
                elif self.cube_cubies[8] == 2: self.cube_stickers[0][0][1] = 2
                elif self.cube_cubies[8] == 3: self.cube_stickers[3][0][1] = 2
                # 11
                if self.cube_cubies[9] == 0: self.cube_stickers[0][1][2] = 1
                elif self.cube_cubies[9] == 1: self.cube_stickers[4][1][0] = 1
                elif self.cube_cubies[9] == 2: self.cube_stickers[0][1][2] = 2
                elif self.cube_cubies[9] == 3: self.cube_stickers[4][1][0] = 2
                # 12
                if self.cube_cubies[10] == 0: self.cube_stickers[0][2][1] = 1
                elif self.cube_cubies[10] == 1: self.cube_stickers[2][0][1] = 1
                elif self.cube_cubies[10] == 2: self.cube_stickers[0][2][1] = 2
                elif self.cube_cubies[10] == 3: self.cube_stickers[2][0][1] = 2
                # 13
                if self.cube_cubies[11] == 0: self.cube_stickers[0][1][0] = 1
                elif self.cube_cubies[11] == 1: self.cube_stickers[5][1][2] = 1
                elif self.cube_cubies[11] == 2: self.cube_stickers[0][1][0] = 2
                elif self.cube_cubies[11] == 3: self.cube_stickers[5][1][2] = 2
                # 14
                if self.cube_cubies[12] == 0: self.cube_stickers[1][0][1] = 1
                elif self.cube_cubies[12] == 1: self.cube_stickers[3][2][1] = 1
                elif self.cube_cubies[12] == 2: self.cube_stickers[1][0][1] = 2
                elif self.cube_cubies[12] == 3: self.cube_stickers[3][2][1] = 2
                # 15
                if self.cube_cubies[13] == 0: self.cube_stickers[1][1][0] = 1
                elif self.cube_cubies[13] == 1: self.cube_stickers[4][1][2] = 1
                elif self.cube_cubies[13] == 2: self.cube_stickers[1][1][0] = 2
                elif self.cube_cubies[13] == 3: self.cube_stickers[4][1][2] = 2
                # 16
                if self.cube_cubies[14] == 0: self.cube_stickers[1][2][1] = 1
                elif self.cube_cubies[14] == 1: self.cube_stickers[2][2][1] = 1
                elif self.cube_cubies[14] == 2: self.cube_stickers[1][2][1] = 2
                elif self.cube_cubies[14] == 3: self.cube_stickers[2][2][1] = 2
                # 17
                if self.cube_cubies[15] == 0: self.cube_stickers[1][1][2] = 1
                elif self.cube_cubies[15] == 1: self.cube_stickers[5][1][0] = 1
                elif self.cube_cubies[15] == 2: self.cube_stickers[1][1][2] = 2
                elif self.cube_cubies[15] == 3: self.cube_stickers[5][1][0] = 2
                # 18
                if self.cube_cubies[16] == 0: self.cube_stickers[3][1][2] = 1
                elif self.cube_cubies[16] == 1: self.cube_stickers[5][0][1] = 1
                elif self.cube_cubies[16] == 2: self.cube_stickers[3][1][2] = 2
                elif self.cube_cubies[16] == 3: self.cube_stickers[5][0][1] = 2
                # 19
                if self.cube_cubies[17] == 0: self.cube_stickers[3][1][0] = 1
                elif self.cube_cubies[17] == 1: self.cube_stickers[4][0][1] = 1
                elif self.cube_cubies[17] == 2: self.cube_stickers[3][1][0] = 2
                elif self.cube_cubies[17] == 3: self.cube_stickers[4][0][1] = 2
                # 110
                if self.cube_cubies[18] == 0: self.cube_stickers[2][1][2] = 1
                elif self.cube_cubies[18] == 1: self.cube_stickers[4][2][1] = 1
                elif self.cube_cubies[18] == 2: self.cube_stickers[2][1][2] = 2
                elif self.cube_cubies[18] == 3: self.cube_stickers[4][2][1] = 2
                # 111
                if self.cube_cubies[19] == 0: self.cube_stickers[2][1][0] = 1
                elif self.cube_cubies[19] == 1: self.cube_stickers[5][2][1] = 1
                elif self.cube_cubies[19] == 2: self.cube_stickers[2][1][0] = 2
                elif self.cube_cubies[19] == 3: self.cube_stickers[5][2][1] = 2
        ...
        if self.stickers_used:
            ...
            # outline in cubie notation:
            self.cube_cubies = [0 for i in range(20)]
            
            
            # corners
            # 00
            if self.cube_stickers[0][0][0] == 1: self.cube_cubies[0] = 0
            elif self.cube_stickers[5][0][2] == 1: self.cube_cubies[0] = 1
            elif self.cube_stickers[3][0][2] == 1: self.cube_cubies[0] = 2
            # 01
            if self.cube_stickers[0][0][2] == 1: self.cube_cubies[1] = 0
            elif self.cube_stickers[3][0][0] == 1: self.cube_cubies[1] = 1
            elif self.cube_stickers[4][0][0] == 1: self.cube_cubies[1] = 2
            # 02
            if self.cube_stickers[0][2][2] == 1: self.cube_cubies[2] = 0
            elif self.cube_stickers[4][2][0] == 1: self.cube_cubies[2] = 1
            elif self.cube_stickers[2][0][2] == 1: self.cube_cubies[2] = 2
            # 03
            if self.cube_stickers[0][2][0] == 1: self.cube_cubies[3] = 0
            elif self.cube_stickers[2][0][0] == 1: self.cube_cubies[3] = 1
            elif self.cube_stickers[5][2][2] == 1: self.cube_cubies[3] = 2
            # 04
            if self.cube_stickers[1][0][2] == 1: self.cube_cubies[4] = 0
            elif self.cube_stickers[3][2][2] == 1: self.cube_cubies[4] = 1
            elif self.cube_stickers[5][0][0] == 1: self.cube_cubies[4] = 2
            # 05
            if self.cube_stickers[1][0][0] == 1: self.cube_cubies[5] = 0
            elif self.cube_stickers[4][0][2] == 1: self.cube_cubies[5] = 1
            elif self.cube_stickers[3][2][0] == 1: self.cube_cubies[5] = 2
            # 06
            if self.cube_stickers[1][2][0] == 1: self.cube_cubies[6] = 0
            elif self.cube_stickers[2][2][2] == 1: self.cube_cubies[6] = 1
            elif self.cube_stickers[4][2][2] == 1: self.cube_cubies[6] = 2
            # 07
            if self.cube_stickers[1][2][2] == 1: self.cube_cubies[7] = 0
            elif self.cube_stickers[5][2][0] == 1: self.cube_cubies[7] = 1
            elif self.cube_stickers[2][2][0] == 1: self.cube_cubies[7] = 2

            # edges
            # 10
            if self.cube_stickers[0][0][1] == 1: self.cube_cubies[8] = 0
            elif self.cube_stickers[3][0][1] == 1: self.cube_cubies[8] = 1
            elif self.cube_stickers[0][0][1] == 2: self.cube_cubies[8] = 2
            elif self.cube_stickers[3][0][1] == 2: self.cube_cubies[8] = 3
            # 11
            if self.cube_stickers[0][1][2] == 1: self.cube_cubies[9] = 0
            elif self.cube_stickers[4][1][0] == 1: self.cube_cubies[9] = 1
            elif self.cube_stickers[0][1][2] == 2: self.cube_cubies[9] = 2
            elif self.cube_stickers[4][1][0] == 2: self.cube_cubies[9] = 3
            # 12
            if self.cube_stickers[0][2][1] == 1: self.cube_cubies[10] = 0
            elif self.cube_stickers[2][0][1] == 1: self.cube_cubies[10] = 1
            elif self.cube_stickers[0][2][1] == 2: self.cube_cubies[10] = 2
            elif self.cube_stickers[2][0][1] == 2: self.cube_cubies[10] = 3
            # 13
            if self.cube_stickers[0][1][0] == 1: self.cube_cubies[11] = 0
            elif self.cube_stickers[5][1][2] == 1: self.cube_cubies[11] = 1
            elif self.cube_stickers[0][1][0] == 2: self.cube_cubies[11] = 2
            elif self.cube_stickers[5][1][2] == 2: self.cube_cubies[11] = 3
            # 14
            if self.cube_stickers[1][0][1] == 1: self.cube_cubies[12] = 0
            elif self.cube_stickers[3][2][1] == 1: self.cube_cubies[12] = 1
            elif self.cube_stickers[1][0][1] == 2: self.cube_cubies[12] = 2
            elif self.cube_stickers[3][2][1] == 2: self.cube_cubies[12] = 3
            # 15
            if self.cube_stickers[1][1][0] == 1: self.cube_cubies[13] = 0
            elif self.cube_stickers[4][1][2] == 1: self.cube_cubies[13] = 1
            elif self.cube_stickers[1][1][0] == 2: self.cube_cubies[13] = 2
            elif self.cube_stickers[4][1][2] == 2: self.cube_cubies[13] = 3
            # 16
            if self.cube_stickers[1][2][1] == 1: self.cube_cubies[14] = 0
            elif self.cube_stickers[2][2][1] == 1: self.cube_cubies[14] = 1
            elif self.cube_stickers[1][2][1] == 2: self.cube_cubies[14] = 2
            elif self.cube_stickers[2][2][1] == 2: self.cube_cubies[14] = 3
            # 17
            if self.cube_stickers[1][1][2] == 1: self.cube_cubies[15] = 0
            elif self.cube_stickers[5][1][0] == 1: self.cube_cubies[15] = 1
            elif self.cube_stickers[1][1][2] == 2: self.cube_cubies[15] = 2
            elif self.cube_stickers[5][1][0] == 2: self.cube_cubies[15] = 3
            # 18
            if self.cube_stickers[3][1][2] == 1: self.cube_cubies[16] = 0
            elif self.cube_stickers[5][0][1] == 1: self.cube_cubies[16] = 1
            elif self.cube_stickers[3][1][2] == 2: self.cube_cubies[16] = 2
            elif self.cube_stickers[5][0][1] == 2: self.cube_cubies[16] = 3
            # 19
            if self.cube_stickers[3][1][0] == 1: self.cube_cubies[17] = 0
            elif self.cube_stickers[4][0][1] == 1: self.cube_cubies[17] = 1
            elif self.cube_stickers[3][1][0] == 2: self.cube_cubies[17] = 2
            elif self.cube_stickers[4][0][1] == 2: self.cube_cubies[17] = 3
            # 110
            if self.cube_stickers[2][1][2] == 1: self.cube_cubies[18] = 0
            elif self.cube_stickers[4][2][1] == 1: self.cube_cubies[18] = 1
            elif self.cube_stickers[2][1][2] == 2: self.cube_cubies[18] = 2
            elif self.cube_stickers[4][2][1] == 2: self.cube_cubies[18] = 3
            # 111
            if self.cube_stickers[2][1][0] == 1: self.cube_cubies[19] = 0
            elif self.cube_stickers[5][2][1] == 1: self.cube_cubies[19] = 1
            elif self.cube_stickers[2][1][0] == 2: self.cube_cubies[19] = 2
            elif self.cube_stickers[5][2][1] == 2: self.cube_cubies[19] = 3
    ...
    def turn_U(self):
        ...
        # corners
        # save 00
        saved = self.cube_cubies[0]
        # move 03 to 00
        self.cube_cubies[0] = self.cube_cubies[3]
        # move 02 to 03
        self.cube_cubies[3] = self.cube_cubies[2]
        # move 01 to 02
        self.cube_cubies[2] = self.cube_cubies[1]
        # move saved to 01
        self.cube_cubies[1] = saved

        # edges
        # save 10
        saved = self.cube_cubies[8]
        # move 13 to 10
        self.cube_cubies[8] = self.cube_cubies[11]
        # move 12 to 13
        self.cube_cubies[11] = self.cube_cubies[10]
        # move 11 to 12
        self.cube_cubies[10] = self.cube_cubies[9]
        # move saved to 11
        self.cube_cubies[9] = saved
    ...
    def turn_U_prime(self):
        ...
        saved = self.cube_cubies[0]
        # move 01 to 00
        self.cube_cubies[0] = self.cube_cubies[1]
        # move 02 to 01
        self.cube_cubies[1] = self.cube_cubies[2]
        # move 03 to 02
        self.cube_cubies[2] = self.cube_cubies[3]
        # move saved to 03
        self.cube_cubies[3] = saved

        # edges
        # save 10
        saved = self.cube_cubies[8]
        # move 11 to 10
        self.cube_cubies[8] = self.cube_cubies[9]
        # move 12 to 11
        self.cube_cubies[9] = self.cube_cubies[10]
        # move 13 to 12
        self.cube_cubies[10] = self.cube_cubies[11]
        # move saved to 13
        self.cube_cubies[11] = saved
    ...
    def turn_U2(self):
        ...
        self.cube_cubies[0] = self.cube_cubies[2]
        # move saved to 02
        self.cube_cubies[2] = saved
        
        # save 01
        saved = self.cube_cubies[1]
        # move 03 to 01
        self.cube_cubies[1] = self.cube_cubies[3]
        # move saved to 03
        self.cube_cubies[3] = saved
        ...
        self.cube_cubies[8] = self.cube_cubies[10]
        # move saved to 12
        self.cube_cubies[10] = saved

        # save 11
        saved = self.cube_cubies[9]
        # move 13 to 11
        self.cube_cubies[9] = self.cube_cubies[11]
        # move saved to 13
        self.cube_cubies[11] = saved
    ...
    def turn_D(self):
        ...
        # corners
        # save 04
        saved = self.cube_cubies[4]
        # move 05 to 04
        self.cube_cubies[4] = self.cube_cubies[5]
        # move 06 to 05
        self.cube_cubies[5] = self.cube_cubies[6]
        # move 07 to 06
        self.cube_cubies[6] = self.cube_cubies[7]
        # move saved to 07
        self.cube_cubies[7] = saved

        # edges
        # save 14
        saved = self.cube_cubies[12]
        # move 15 to 14
        self.cube_cubies[12] = self.cube_cubies[13]
        # move 16 to 15
        self.cube_cubies[13] = self.cube_cubies[14]
        # move 17 to 16
        self.cube_cubies[14] = self.cube_cubies[15]
        # move saved to 17
        self.cube_cubies[15] = saved
    ...
    def turn_D_prime(self):
        ...
        saved = self.cube_cubies[4]
        # move 07 to 04
        self.cube_cubies[4] = self.cube_cubies[7]
        # move 06 to 07
        self.cube_cubies[7] = self.cube_cubies[6]
        # move 05 to 06
        self.cube_cubies[6] = self.cube_cubies[5]
        # move saved to 05
        self.cube_cubies[5] = saved

        # edges
        # save 14
        saved = self.cube_cubies[12]
        # move 17 to 14
        self.cube_cubies[12] = self.cube_cubies[15]
        # move 16 to 17
        self.cube_cubies[15] = self.cube_cubies[14]
        # move 15 to 16
        self.cube_cubies[14] = self.cube_cubies[13]
        # move saved to 15
        self.cube_cubies[13] = saved
    ...
    def turn_D2(self):
        ...
        self.cube_cubies[4] = self.cube_cubies[6]
        # move saved to 06
        self.cube_cubies[6] = saved
        
        # save 05
        saved = self.cube_cubies[5]
        # move 07 to 05
        self.cube_cubies[5] = self.cube_cubies[7]
        # move saved to 07
        self.cube_cubies[7] = saved
        ...
        self.cube_cubies[12] = self.cube_cubies[14]
        # move saved to 16
        self.cube_cubies[14] = saved

        # save 15
        saved = self.cube_cubies[13]
        # move 17 to 15
        self.cube_cubies[13] = self.cube_cubies[15]
        # move saved to 17
        self.cube_cubies[15] = saved
    ...
    def turn_F(self):
        ...
        # corners
        # save 02
        saved = self.cube_cubies[2]
        # move 03 to 02
        self.cube_cubies[2] = (self.cube_cubies[3]+1)%3
        # move 07 to 03
        self.cube_cubies[3] = (self.cube_cubies[7]-1)%3
        # move 06 to 07
        self.cube_cubies[7] = (self.cube_cubies[6]+1)%3
        # move saved to 06
        self.cube_cubies[6] = (saved-1)%3

        # edges
        # save 12
        saved = self.cube_cubies[10]
        # move 111 to 12
        match self.cube_cubies[19]:
            case 0:
                self.cube_cubies[10] = 1
            case 1:
                self.cube_cubies[10] = 0
            case 2:
                self.cube_cubies[10] = 3
            case 3:
                self.cube_cubies[10] = 2
        # move 16 to 111
        match self.cube_cubies[14]:
            case 0:
                self.cube_cubies[19] = 1
            case 1:
                self.cube_cubies[19] = 0
            case 2:
                self.cube_cubies[19] = 3
            case 3:
                self.cube_cubies[19] = 2
        # move 110 to 16
        match self.cube_cubies[18]:
            case 0:
                self.cube_cubies[14] = 1
            case 1:
                self.cube_cubies[14] = 0
            case 2:
                self.cube_cubies[14] = 3
            case 3:
                self.cube_cubies[14] = 2
        # move saved to 110
        match saved:
            case 0:
                self.cube_cubies[18] = 1
            case 1:
                self.cube_cubies[18] = 0
            case 2:
                self.cube_cubies[18] = 3
            case 3:
                self.cube_cubies[18] = 2
    ...
    def turn_F_prime(self):
        ...
        saved = self.cube_cubies[2]
        # move 06 to 02
        self.cube_cubies[2] = (self.cube_cubies[6]+1)%3
        # move 07 to 06
        self.cube_cubies[6] = (self.cube_cubies[7]-1)%3
        # move 03 to 07
        self.cube_cubies[7] = (self.cube_cubies[3]+1)%3
        # move saved to 03
        self.cube_cubies[3] = (saved-1)%3
    ...
    def turn_F2(self):
        ...
        saved = self.cube_cubies[2]
        # move 07 to 02
        self.cube_cubies[2] = self.cube_cubies[7]
        # move saved to 07
        self.cube_cubies[7] = saved

        # save 03
        saved = self.cube_cubies[3]
        # move 06 to 03
        self.cube_cubies[3] = self.cube_cubies[6]
        # move saved to 06
        self.cube_cubies[6] = saved
        ...
        saved = self.cube_cubies[10]
        # move 16 to 12
        self.cube_cubies[10] = self.cube_cubies[14]
        # move saved to 16
        self.cube_cubies[14] = saved

        # save 110
        saved = self.cube_cubies[18]
        # move 111 to 110
        self.cube_cubies[18] = self.cube_cubies[19]
        # move saved to 111
        self.cube_cubies[19] = saved
    ...
    def turn_B(self):
        ...
        saved = self.cube_cubies[0]
        # move 01 to 00
        self.cube_cubies[0] = (self.cube_cubies[1]+1)%3
        # move 05 to 01
        self.cube_cubies[1] = (self.cube_cubies[5]-1)%3
        # move 04 to 05
        self.cube_cubies[5] = (self.cube_cubies[4]+1)%3
        # move saved to 04
        self.cube_cubies[4] = (saved-1)%3

        # edges
        # save 10
        saved = self.cube_cubies[8]
        # move 19 to 10
        match self.cube_cubies[17]:
            case 0:
                self.cube_cubies[8] = 1
            case 1:
                self.cube_cubies[8] = 0
            case 2:
                self.cube_cubies[8] = 3
            case 3:
                self.cube_cubies[8] = 2
        # move 14 to 19
        match self.cube_cubies[12]:
            case 0:
                self.cube_cubies[17] = 1
            case 1:
                self.cube_cubies[17] = 0
            case 2:
                self.cube_cubies[17] = 3
            case 3:
                self.cube_cubies[17] = 2
        # move 18 to 14
        match self.cube_cubies[16]:
            case 0:
                self.cube_cubies[12] = 1
            case 1:
                self.cube_cubies[12] = 0
            case 2:
                self.cube_cubies[12] = 3
            case 3:
                self.cube_cubies[12] = 2
        # move saved to 18
        match saved:
            case 0:
                self.cube_cubies[16] = 1
            case 1:
                self.cube_cubies[16] = 0
            case 2:
                self.cube_cubies[16] = 3
            case 3:
                self.cube_cubies[16] = 2
    ...
    def turn_B_prime(self):
        ...
        saved = self.cube_cubies[0]
        # move 04 to 00
        self.cube_cubies[0] = (self.cube_cubies[4]+1)%3
        # move 05 to 04
        self.cube_cubies[4] = (self.cube_cubies[5]-1)%3
        # move 01 to 05
        self.cube_cubies[5] = (self.cube_cubies[1]+1)%3
        # move saved to 01
        self.cube_cubies[1] = (saved-1)%3
    ...
    def turn_B2(self):
        ...
        saved = self.cube_cubies[0]
        # move 05 to 00
        self.cube_cubies[0] = self.cube_cubies[5]
        # move saved to 05
        self.cube_cubies[5] = saved
        ...
        saved = self.cube_cubies[1]
        # move 04 to 01
        self.cube_cubies[1] = self.cube_cubies[4]
        # move saved to 04
        self.cube_cubies[4] = saved

        # edges
        # save 10
        saved = self.cube_cubies[8]
        # move 14 to 10
        self.cube_cubies[8] = self.cube_cubies[12]
        # move saved to 14
        self.cube_cubies[12] = saved

        # save 18
        saved = self.cube_cubies[16]
        # move 19 to 18
        self.cube_cubies[16] = self.cube_cubies[17]
        # move saved to 19
        self.cube_cubies[17] = saved
    ...
    def turn_R(self):
        ...
        saved = self.cube_cubies[1]
        # move 02 to 01
        self.cube_cubies[1] = (self.cube_cubies[2]+1)%3
        # move 06 to 02
        self.cube_cubies[2] = (self.cube_cubies[6]-1)%3
        # move 05 to 06
        self.cube_cubies[6] = (self.cube_cubies[5]+1)%3
        # move saved to 05
        self.cube_cubies[5] = (saved-1)%3

        # edges
        # save 11
        saved = self.cube_cubies[9]
        # move 110 to 11
        self.cube_cubies[9] = self.cube_cubies[18]
        # move 15 to 110
        self.cube_cubies[18] = self.cube_cubies[13]
        # move 19 to 15
        self.cube_cubies[13] = self.cube_cubies[17]
        # move saved to 19
        self.cube_cubies[17] = saved
    ...
    def turn_R_prime(self):
        ...
        self.cube_cubies[1] = (self.cube_cubies[5]+1)%3
        # move 06 to 05
        self.cube_cubies[5] = (self.cube_cubies[6]-1)%3
        # move 02 to 06
        self.cube_cubies[6] = (self.cube_cubies[2]+1)%3
        # move saved to 02
        self.cube_cubies[2] = (saved-1)%3

        # edges
        # save 11
        saved = self.cube_cubies[9]
        # move 19 to 11
        self.cube_cubies[9] = self.cube_cubies[17]
        # move 15 to 19
        self.cube_cubies[17] = self.cube_cubies[13]
        # move 110 to 15
        self.cube_cubies[13] = self.cube_cubies[18]
        # move saved to 110
        self.cube_cubies[18] = saved
    ...
    def turn_R2(self):
        ...
        saved = self.cube_cubies[1]
        # move 06 to 01
        self.cube_cubies[1] = self.cube_cubies[6]
        # move saved to 06
        self.cube_cubies[6] = saved
        ...
        saved = self.cube_cubies[2]
        # move 05 to 02
        self.cube_cubies[2] = self.cube_cubies[5]
        # move saved to 05
        self.cube_cubies[5] = saved
        ...
        saved = self.cube_cubies[9]
        # move 15 to 11
        self.cube_cubies[9] = self.cube_cubies[13]
        # move saved to 15
        self.cube_cubies[13] = saved

        # save 19
        saved = self.cube_cubies[17]
        # move 110 to 19
        self.cube_cubies[17] = self.cube_cubies[18]
        # move saved to 110
        self.cube_cubies[18] = saved
    ...
    def turn_L(self):
        ...
        self.cube_cubies[0] = (self.cube_cubies[4]-1)%3
        # move 07 to 04
        self.cube_cubies[4] = (self.cube_cubies[7]+1)%3
        # move 03 to 07
        self.cube_cubies[7] = (self.cube_cubies[3]-1)%3
        # move saved to 03
        self.cube_cubies[3] = (saved+1)%3
        ...
        # edges
        # save 13
        saved = self.cube_cubies[11]
        # move 18 to 13
        self.cube_cubies[11] = self.cube_cubies[16]
        # move 17 to 18
        self.cube_cubies[16] = self.cube_cubies[15]
        # move 111 to 17
        self.cube_cubies[15] = self.cube_cubies[19]
        # move saved to 111
        self.cube_cubies[19] = saved
    ...
    def turn_L_prime(self):
        ...
        saved = self.cube_cubies[0]
        # move 03 to 00
        self.cube_cubies[0] = (self.cube_cubies[3]-1)%3
        # move 07 to 03
        self.cube_cubies[3] = (self.cube_cubies[7]+1)%3
        # move 04 to 07
        self.cube_cubies[7] = (self.cube_cubies[4]-1)%3
        # move saved to 04
        self.cube_cubies[4] = (saved+1)%3
        ...
        saved = self.cube_cubies[11]
        # move 111 to 13
        self.cube_cubies[11] = self.cube_cubies[19]
        # move 17 to 111
        self.cube_cubies[19] = self.cube_cubies[15]
        # move 18 to 17
        self.cube_cubies[15] = self.cube_cubies[16]
        # move saved to 18
        self.cube_cubies[16] = saved
    ...
    def turn_L2(self):
        ...
        saved = self.cube_cubies[0]
        # move 07 to 00
        self.cube_cubies[0] = self.cube_cubies[7]
        # move saved to 07
        self.cube_cubies[7] = saved
        ...
        saved = self.cube_cubies[3]
        # move 04 to 03
        self.cube_cubies[3] = self.cube_cubies[4]
        # move saved to 04
        self.cube_cubies[4] = saved
        ...
        saved = self.cube_cubies[11]
        # move 17 to 13
        self.cube_cubies[11] = self.cube_cubies[15]
        # move saved to 17
        self.cube_cubies[15] = saved
        ...
        saved = self.cube_cubies[16]
        # move 111 to 18
        self.cube_cubies[16] = self.cube_cubies[19]
        # move saved to 111
        self.cube_cubies[19] = saved

        return self

    def check_step1(self, solved_step1=SOLVED_STEP1_CUBIE_BW):
        ...
        if self.cube_cubies == solved_step1:
            return True
        return False
...
def generate_cube(solved=True, scramble=None):
    ...
    cube = Cube_BW(solved, scramble)
    return cube

if __name__ == "__main__":
    """
    cube = generate_cube()
    cube.turn("R'U2F_D_L_U2R2")

    totalstarttime = time.time()

    cube_bw = Cube_BW(solved=False,scramble=cube.bw_cube())

    step1_starttime = time.time()
    step1_found = False
    n = -1
    while not step1_found:
        n += 1
        print(f"Looking for solution of step 1 with depth {n}...")
        starttime = time.time()
        step1_found, solution_1 = cube_bw.recursive_solving(n)
        print(f"Time used for depth {n}: {time.time()-starttime} seconds")
    step1_time = time.time()-step1_starttime

    print(f"Solution of step 1 with depth {n}: {solution_1} (Time used: {step1_time} seconds)")

    cube.turn(solution_1)

    step2_starttime = time.time()
    step2_found = False
    n = -1
    while not step2_found:
        n += 1
        print(f"Looking for solution of step 2 with depth {n}...")
        starttime = time.time()
        step2_found, solution_2 = cube.recursive_solving(n)
        print(f"Time used for depth {n}: {time.time()-starttime} seconds")
    step2_time = time.time()-step2_starttime
    
    print(f"Solution of step 2 with depth {n}: {solution_2} (Time used: {step2_time} seconds)")

    solution = solution_1+solution_2
    print(f"Total solution: {solution} (Time used: {time.time()-totalstarttime} seconds)")
    """

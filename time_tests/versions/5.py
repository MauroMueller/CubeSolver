...
# This file does exactly the same as the file basic_functions_linear.py, but uses a numpy array instead of a python list. This decreases performance by ≈-100% but might be optimized with vectorized operations
...
SOLVED_STATE_CUBIE_LINEAR = np.array([0 for i in range(40)])
...
class Cube():
    ...
    def get_cube_state(self, sticker_notation=False, cubie_list=CUBIE_LIST):
        ...
        if self.stickers_used:
            ...
            self.cube_cubies = np.array([0 for i in range(40)])
    ...
    def turn_U(self):
        ...
        # corners
        # save 00
        saved = np.array(self.cube_cubies[0:2])
        # move 03 to 00
        ...
        # edges
        # save 10
        saved = np.array(self.cube_cubies[16:18])
        # move 13 to 10
    ...
    def turn_U2(self):
        ...
        # save 01
        saved = np.array(self.cube_cubies[2:4])
        # move 03 to 01
        ...
        # save 11
        saved = np.array(self.cube_cubies[18:20])
        # move 13 to 11
    ...
    def turn_D(self):
        ...
        # corners
        # save 04
        saved = np.array(self.cube_cubies[8:10])
        # move 05 to 04
        ...
        # edges
        # save 14
        saved = np.array(self.cube_cubies[24:26])
        # move 15 to 14
    ...
    def turn_D2(self):
        ...
        # save 05
        saved = np.array(self.cube_cubies[10:12])
        # move 07 to 05
        ...
        # save 15
        saved = np.array(self.cube_cubies[26:28])
        # move 17 to 15
    ...
    def turn_F(self):
        ...
        # corners
        # save 02
        saved = np.array(self.cube_cubies[4:6])
        # move 03 to 02
        ...
        # edges
        # save 12
        saved = np.array(self.cube_cubies[20:22])
        # move 111 to 12
    ...
    def turn_F2(self):
        ...
        # save 03
        saved = np.array(self.cube_cubies[6:8])
        # move 06 to 03
        ...
        # save 110
        saved = np.array(self.cube_cubies[36:38])
        # move 111 to 110
    ...
    def turn_B2(self):
        ...
        # save 18
        saved = np.array(self.cube_cubies[32:34])
        # move 19 to 18
    ...
    def turn_R2(self):
        ...
        # save 19
        saved = np.array(self.cube_cubies[34:36])
        # move 110 to 19
    ...
    def turn_L(self):
        ...
        # edges
        # save 13
        saved = np.array(self.cube_cubies[22:24])
        # move 18 to 13
    ...
    def check_solved(self, solved_state=SOLVED_STATE_CUBIE_LINEAR):
        ...
        if np.array_equal(self.get_cube_state(), solved_state):
            return True
        return False

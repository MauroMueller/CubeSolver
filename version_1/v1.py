...
class Cube():
    ...
    def recursive_solving(self, depth):
        ...
        if depth > 0:
            ...
            solved, string = self.turn_U().recursive_solving(depth)
            ...
            solved, string = self.turn_U_prime().recursive_solving(depth)
            #print(f"{string} U' accomplished (depth {depth}), Result: {solved}")
            if solved and (found == -1 or found > len(string)):
                found = len(string)
            ...
            solved, string = self.turn_U2().recursive_solving(depth)
            ...
            solved, string = self.turn_D().recursive_solving(depth)
            ...
            solved, string = self.turn_D_prime().recursive_solving(depth)
            #print(f"{string} D' accomplished (depth {depth}), Result: {solved}")
            if solved and (found == -1 or found > len(string)):
                found = len(string)
            ...
            solved, string = self.turn_D2().recursive_solving(depth)
            ...
            solved, string = self.turn_F().recursive_solving(depth)
            ...
            solved, string = self.turn_F_prime().recursive_solving(depth)
            #print(f"{string} F' accomplished (depth {depth}), Result: {solved}")
            if solved and (found == -1 or found > len(string)):
                found = len(string)
            ...
            solved, string = self.turn_F2().recursive_solving(depth)
            ...
            solved, string = self.turn_B().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
                foundstring = "B_"+string
            self.turn_B_prime()

            solved, string = self.turn_B_prime().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
                foundstring = "B'"+string
            self.turn_B()

            solved, string = self.turn_B2().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
                foundstring = "B2"+string
            self.turn_B2()

            solved, string = self.turn_R().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
                foundstring = "R_"+string
            self.turn_R_prime()

            solved, string = self.turn_R_prime().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
                foundstring = "R'"+string
            self.turn_R()

            solved, string = self.turn_R2().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
                foundstring = "R2"+string
            self.turn_R2()

            solved, string = self.turn_L().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
                foundstring = "L_"+string
            self.turn_L_prime()

            solved, string = self.turn_L_prime().recursive_solving(depth)
            ...
            solved, string = self.turn_L2().recursive_solving(depth)
            if solved and (found == -1 or found > len(string)):
                found = len(string)
